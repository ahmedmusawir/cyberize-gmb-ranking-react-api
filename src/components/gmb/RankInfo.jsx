...
const getBackgroundColor = (rank) => {
  ...
  //   if (rank === 1) return '#254F2E';
  if (rank === 2) return 'greenyellow';
  //   if (rank === 2) return '#3D824C';
  ...
  if (rank >= 16 && rank <= 20) return '#CC0000';
  if (rank >= 21) return '#800000';
};
...
const RankInfo = ({ location }) => {
  ...
  return (
    <div
      className="w-8 h-8 border-2 border-red-500 rounded-full m-2 relative"
